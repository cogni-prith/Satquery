#!/usr/bin/env python3
"""Entry point for the change training run.
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--config", default="configs/train/change.yaml")
    ...
    raise NotImplementedError(
        "change training is not implemented. Missing: the model builder in "
